...
INTERACTIVE_TOOLS = {
    ...
    "GPAI": ("GPAI- und BSI-Compliance-Checkliste", ["assessment", "checklist", "notes", "progress", "pdf"]),
    "haip": ("Beschaffungs- und BSI-Checkliste", ["assessment", "checklist", "notes", "progress", "pdf"]),
